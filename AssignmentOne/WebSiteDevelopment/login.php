...
<table>
<tr>
<td><label for="username_email">User:</label></td>
<td><input type="text" name="username_email" id="username_email" autofocus value="<?php echo $username_email; ?>">
<span class="error" id="username_error">
<?php echo $msg_username; // These variables need to match the error variables that are set in the validation script ?></span></td>
</tr>
<tr>
<td><label for="password">Password:</label></td>
<td><input type="password" name="password" id="password" value="<?php echo $password; ?>">
<span class="error" id="password_error">
<?php echo $msg_password; ?></span></td>
</tr>
<tr>
